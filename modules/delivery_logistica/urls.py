...
urlpatterns = [
    ...
    path("delivery/availability/", delivery_availability_view),
    path("delivery/offers/pending/", delivery_pending_offers_view),
    path("delivery/open-board/", delivery_open_board_view),
    path("delivery/<str:assignment_id>/", delivery_detail_view),
    path("delivery/<str:assignment_id>/accept/", delivery_accept_view),
    path("delivery/<str:assignment_id>/claim/", delivery_claim_view),
    path("delivery/<str:assignment_id>/reject/", delivery_reject_view),
    path("delivery/<str:assignment_id>/cancel/", delivery_cancel_view),
